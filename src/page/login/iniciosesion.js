    ...
    <div className="font-Montserrat">
      <picture>
        <img
          src={InisioSesion}
          alt=""
          className="h-96 sm:h-full sm:w-full md:h-screen md:w-screen"
        />
      </picture>
      <div
      ...
      <div className="flex flex-col">
        <p
          className="text-[#EFB810] absolute font-bold 
        ...
        <div className="absolute top-[29%] sm:top-[35%] sm:ml-[20%] md:top-[45%] md:ml-[21%]">
          <label
            for="correo"
            className="text-[#EFB810] font-bold
                        text-base ml-[45%]
                        sm:text-sm sm:ml-[33%] 
          ...
          <br />
          <input
            className="bg-[#717171] placeholder-white rounded-2xl 
        ...
        <Link to="/Contraseña">
          <button
            className="absolute text-[#EFB810] font-bold 
        ...
        <div className="flex">
          <button
            className="absolute bg-[#EFB810] text-white rounded-2xl
