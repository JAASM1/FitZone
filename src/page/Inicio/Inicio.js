        ...
        <div ref={ref}>
            ...
            >
              ...
              <div>
                {isLoggedIn ? (
                  <p>
                    Bienvenido,{" "}
                    <span className="text-[#EFB810]">{username}</span>{" "}
                  </p>
                ) : (
          ...
          <div className="flex flex-col p-20 gap-20">
            ...
            <div className="grid md:grid-cols-3 md:gap-36 gap-5 justify-center">
              <motion.div
                ...
                animate={controls}
                transition={{ duration: 0.5, delay: 0.25 }}
                className="bg-black w-[298px] h-[250px] flex flex-col justify-center items-center p-10 gap-3 rounded-3xl"
              >
                <img
                  src={iconEjercicio}
                  alt="icono ejercicio"
                ...
                <p className="text-sm font-light text-center">
                  Proporcionar información sobre ejercicios específicos
                  dirigidos a diferentes grupos musculares
                </p>
              </motion.div>
              <motion.div
                variants={{
          ...
          <div className="flex flex-col items-end justify-center">
            <motion.div
              ...
              animate={controls}
              transition={{ duration: 0.5, delay: 0.25 }}
              className="flex flex-col bg-[#EFB810] text-black md:w-[724px] md:h-[478px] w-[250px] h-[180px] md:gap-11 gap-2 justify-center items-center absolute md:right-28 right-5"
            >
