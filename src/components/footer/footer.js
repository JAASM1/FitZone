        ...
        <div className='grid md:grid-cols-3 mx-16'>
          <div className='flex flex-col items-center md:gap-12 gap-5'>
            ...
            <div className='flex gap-6 max-md:pb-6'>
              {/* twitter */}
              <a href="https://twitter.com/fit_zone_" target='_blank'>
              ...
              {/* facebook */}
              <a href='https://www.facebook.com/profile.php?id=61554001771083' target='_blank'>
              ...
              {/* instagram */}
              <a href='https://www.instagram.com/fit_zone_mx/' target='_blank'>
